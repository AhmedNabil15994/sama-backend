...
@section('title', __('package::dashboard.suspensions.routes.index'))
@section('content')
  ...
  <div class="page-content">
    <div class="page-bar">
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="#">{{ __('package::dashboard.suspensions.routes.index') }}</a>
        </li>
      </ul>
    </div>
        ...
        <div class="portlet light bordered">
          ...
          <div class="table-toolbar">
            <div class="row">
              <div class="col-md-6">
                <div class="btn-group">
                  <a href="{{ url(route('dashboard.suspensions.create')) }}"
            ...
            <table class="table table-striped table-bordered table-hover"
              ...
              <thead>
                <tr>
                  ...
                  <th>{{ __('package::dashboard.suspensions.datatable.user') }}</th>
                  ...
                  <th data-priority="1">{{ __('package::dashboard.suspensions.datatable.options') }}
                  </th>
                </tr>
              </thead>
            </table>
          ...
          <div class="row">
            <div class="form-group">
              <button type="submit"
                ...
                onclick="deleteAllChecked('{{ url(route('dashboard.suspensions.deletes')) }}')">
...
<script>
  function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.suspensions.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
...
responsivePriority: 1,
              width: '13%',
              title: '{{__('package::dashboard.suspensions.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '{{ route("dashboard.suspensions.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("dashboard.suspensions.destroy", ":id") }}';
      					deleteUrl = deleteUrl.replace(':id', data);

      					return `
                @can('edit_suspensions')
      						<a href="`+editUrl+`" class="btn btn-sm blue" title="Edit">
      			              <i class="fa fa-edit"></i>
      			            </a>
      					@endcan

                @can('delete_suspensions')
                @csrf
