                                ...
                                <div id="collapse_2_1" class="panel-collapse in">
                                    <div class="panel-body">
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li class="">
                                                <a href="#prices" data-toggle="tab" class="prices">
                                                    {{ __('package::dashboard.packages.form.tabs.prices') }}
                                                </a>
                                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in" id="prices">
                                <div class="col-md-10"  id="app">
                                    @include('package::dashboard.packages.prices')
                                </div>
                            </div>
                          ...
                          <div class="tab-pane fade in"
                               id="categories">
                            <div id="jstree">
                              @include('package::dashboard.packages.tree.categories.view',[
