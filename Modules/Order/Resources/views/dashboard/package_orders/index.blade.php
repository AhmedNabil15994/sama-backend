                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                {{__('order::dashboard.orders.datatable.packages')}}
                                                            </label>
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('order::dashboard.orders.datatable.package')}}</th>
...
<script>
    function tableGenerate(data = '') {
        ...
        var dataTable =
            $('#dataTable').DataTable({
                ajax: {
                    url: "{{ url(route('dashboard.orders.datatable')) }}?order_type=package",
                    type: "GET",
                    data: {
                        req: data,
                    },
                ...
                columns: [
                    ...
                    {
                      data: 'package_name',className: 'dt-center'
                    },
                    {
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                          ...
                          location.replace("{{ route('dashboard.orders_packages.exportExcel')}}?" + $.param(requestParams))
                        },
                        exportOptions: {
                            stripHtml: false,
                            columns: ':visible',
