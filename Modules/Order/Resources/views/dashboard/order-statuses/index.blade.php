...
@section('title', __('order::dashboard.order_statuses.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('order::dashboard.order_statuses.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.order-statuses.create')) }}"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('order::dashboard.order_statuses.datatable.title')}}</th>
                                    <th>{{__('order::dashboard.order_statuses.datatable.success_status')}}</th>
                                    <th>{{__('order::dashboard.order_statuses.datatable.failed_status')}}</th>
                                    <th>{{__('order::dashboard.order_statuses.datatable.created_at')}}</th>
                                    <th>{{__('order::dashboard.order_statuses.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.order-statuses.deletes')) }}')">
...
<script>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.order-statuses.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
...
responsivePriority:1,
              width: '13%',
              title: '{{__('order::dashboard.order_statuses.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '{{ route("dashboard.order-statuses.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("dashboard.order-statuses.destroy", ":id") }}';
