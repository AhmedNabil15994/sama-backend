                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.courses.create')) }}" class="btn sbold green">
                                        ...
                                        <form id="formFilter" enctype="multipart/form-data" class="horizontal-form">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    @include('course::dashboard.courses.datatable-filter')
                                                </div>
                                            </div>
                                        </form>
                    ...
                    columnDefs: [
                      ...
                      `;
                        ...
                        },
                        {
                          ...
                          orderable: false,
                          render: function (data, type, full, meta) {
                           let route="{{ route('dashboard.lessoncontents.index',['course_id'=>'--']) }}".replace('--',data);
                           console.log(route);
                          return `<a href="` + route + `"
