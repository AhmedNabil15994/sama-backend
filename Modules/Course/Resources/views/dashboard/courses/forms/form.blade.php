...
{!! field()->number('apple_price', __('course::dashboard.courses.form.apple_price'),null,['step'=>'0.01']) !!}
...
{!! field()->number('period', __('package::dashboard.packages.form.prices.days_count'),null,['step'=>'1']) !!}
