...
<div class="form-group  {{$model->id == null && $model->type !='video_link' ? 'hidden' : ''}}" id="video_link_wrap">
...
@if($model->type=='resource')
  @include('course::trainer.lessoncontents.forms.resource')
@endif
  ...
  <script>
    ...
    <script>
      $(function (){
        ...
        let url="{{ route('trainer.lessons.store') }}"
          ...
          $.ajax({
            ...
            success:  (data)=> {
              ...
              if (data[0] == true) {
                ...
                $.ajax({
                  type: "get",
                  url: "{{ route('trainer.get-courses-ajax') }}",
                  data: "data",
                  dataType: "json",
