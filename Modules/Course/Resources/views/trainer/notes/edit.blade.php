  ...
  <div class="page-content">
    <div class="page-bar">
      <ul class="page-breadcrumb">
        <li>
          <a href="{{ route('trainer.home') }}">{{ __('apps::dashboard.index.title') }}</a>
    ...
    <div class="row">
      {!! Form::model($model, [
      'url' => route('trainer.notes.update', $model->id),
      'id' => 'updateForm',
      'role' => 'form',
      'method' => 'PUT',
        ...
        <div class="col-md-9">
          <div class="tab-content">
            ...
            <div class="tab-pane fade in" id="categories">
              ...
              <div id="jstree">
                @include('course::trainer.notes.tree.categories.view',compact('mainCategories'))
              </div>
