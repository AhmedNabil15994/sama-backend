        ...
        <div class="portlet light bordered">
          ...
          <div class="table-toolbar">
            <div class="row">
              <div class="col-md-6">
                <div class="btn-group">
                  <a href="{{ url(route('trainer.notes.create')) }}" class="btn sbold green">
                    ...
                    <form id="formFilter" enctype="multipart/form-data" class="horizontal-form">
                      <div class="form-body">
                        <div class="row">
                          ...
                          @include('course::trainer.notes.datatable-filter')
                        </div>
                      </div>
                    </form>
          ...
          <div class="row">
            <div class="form-group">
              <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('trainer.notes.deletes')) }}')">
  ...
  function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('trainer.notes.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                      ...
                      `;
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Edit
                                var editUrl = '{{ route("trainer.notes.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("trainer.notes.destroy", ":id") }}';
