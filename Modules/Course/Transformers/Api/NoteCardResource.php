...
class NoteCardResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $url = $this->is_free || ($request->user() && $request->user()->orderNotes()->where('note_id',$this->id)->first()) ? 
            $this->getFirstMediaUrl('pdf') : null;
