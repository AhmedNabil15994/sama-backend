...
@section('title', __('trainer::dashboard.trainers.update.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('trainer::dashboard.trainers.update.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
            'url'=> route('dashboard.trainers.update',$model->id),
            'id'=>'updateForm',
            'role'=>'form',
            'method'=>'PUT',
                                    ...
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li class="active">
                                            <a href="#global_setting"
                                                data-toggle="tab">
                                                {{ __('trainer::dashboard.trainers.update.form.general') }}
                                            </a>
                                        </li>
