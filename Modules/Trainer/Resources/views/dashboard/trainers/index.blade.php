...
@section('title', __('trainer::dashboard.trainers.index.title'))
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('trainer::dashboard.trainers.index.title')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.trainers.create')) }}"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('trainer::dashboard.trainers.datatable.image')}}</th>
                                    <th>{{__('trainer::dashboard.trainers.datatable.name')}}</th>
                                    <th>{{__('trainer::dashboard.trainers.datatable.email')}}</th>
                                    <th>{{__('trainer::dashboard.trainers.datatable.mobile')}}</th>
                                    <th>{{__('trainer::dashboard.trainers.datatable.created_at')}}</th>
                                    <th>{{__('trainer::dashboard.trainers.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.trainers.deletes')) }}')">
...
<script>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.trainers.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
...
responsivePriority:1,
              width: '13%',
              title: '{{__('trainer::dashboard.trainers.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '{{ route("dashboard.trainers.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("dashboard.trainers.destroy", ":id") }}';
