...
trait HandleStatusAndFile
{
     ...
     * @var array
     */
    protected array $statusAttribute = ["status"];

    /**
     * Status attribute in model
     * @var array
     */
    protected $fileAttribute = ["image" => "images"];
     ...
     */
    public function handleFileNormal($model, Request $request, bool $delteBeforeUpdate = false): void
    {
