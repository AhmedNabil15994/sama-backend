...
@section('title', __('exam::dashboard.questions.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('exam::dashboard.questions.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.questions.create')) }}"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('exam::dashboard.questions.datatable.question')}}</th>
                                    <th>{{__('exam::dashboard.questions.datatable.created_at')}}</th>
                                    <th>{{__('exam::dashboard.questions.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
responsivePriority:1,
              width: '13%',
              title: '{{__('exam::dashboard.questions.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
