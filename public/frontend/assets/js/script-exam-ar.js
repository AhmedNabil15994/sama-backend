...
function showTab(n) {
  ...
  if (n == (x.length - 1)) {
    document.getElementById("nextBtn").innerHTML = document.getElementById("prevBtn").getAttribute('end-text-btn');
  } else {
    document.getElementById("nextBtn").innerHTML = document.getElementById("nextBtn").getAttribute('text-btn');
  }
